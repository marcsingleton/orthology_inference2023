...
# Load OGs
OG3s = load_OGs('../subcluster_pgraph/out/pgraph1/pclusters.txt')
OG4s = load_OGs('../clique4+_pcommunity/out/pgraph1/4clique/pclusters.txt')
OG5s = load_OGs('../clique4+_pcommunity/out/pgraph1/5clique/pclusters.txt')
OG6s = load_OGs('../clique4+_pcommunity/out/pgraph1/6clique/pclusters.txt')
...
for i, CCid in enumerate(CCids[:50]):  # 50 largest CCs
    ...
    fig.tight_layout()
    ax.axis('off')
    fig.savefig(f'out/pgraph1/{i}_{CCid}_source.png')
    plt.close()
    ...
    for j, OGjs in zip(range(3, 7), [OG3s, OG4s, OG5s, OG6s]):
        ...
        fig.tight_layout()
        ax.axis('off')
        fig.savefig(f'out/pgraph1/{i}_{CCid}_OG{j}.png')
        plt.close()
    ...
    fig.tight_layout()
    ax.axis('off')
    fig.savefig(f'out/pgraph1/{i}_{CCid}_edge.png')
    plt.close()
...
../clique4+_pcommunity/clique4+_pcommunity1.py
    ...
    ../clique4+_pcommunity/out/pgraph1/5clique/pclusters.txt
    ../clique4+_pcommunity/out/pgraph1/6clique/pclusters.txt
