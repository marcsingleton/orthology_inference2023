"""Fit mixture models to PIC distributions with Laplace and Gaussian mixtures without removing zeroes."""
...
def fit_model(pics_lt, feature, model):
    ...
    for dist in dists:
        ...
        sample_params = pd.DataFrame([cfe(np.random.choice(data[data != 0], n)) for _ in range(500)])
...
num_std = 100  # Number of standard deviations above mean for max of the random initials
