...
k_core_components = ['0008', '0009', '0014', '0025']  # Histones and other complex OGs which directly use k_core
...
CliqueError: 0025
CliqueError: 00B4
PercolateError: (4, 0145)
PercolateError: (5, 0145)
PercolateError: (6, 0145)
PercolateError: (4, 032E)
