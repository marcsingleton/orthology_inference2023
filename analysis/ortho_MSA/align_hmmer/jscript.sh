...
#SBATCH --job-name=align_hmmer
#SBATCH --output=align_hmmer.out
...
if [ ! -d out ]; then
  out_dir=/global/scratch/singleton/IDREvoDevo/analysis/ortho_MSA/align_hmmer/out/
  if [ ! -d ${out_dir} ]; then
