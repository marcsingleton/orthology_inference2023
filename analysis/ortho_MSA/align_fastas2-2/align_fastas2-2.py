...
def run_cmd(file_id):
    aligners = [('probalign', f'../../../bin/probalign ../make_fastas2-2/out/{file_id}.tfa '
                              f'1> out/{file_id}.mfa 2> out/{file_id}.err'),
                ('probcons', f'../../../bin/probcons ../make_fastas2-2/out/{file_id}.tfa '
                             f'1> out/{file_id}.mfa 2> out/{file_id}.err'),
                ('mafft', f'../../../bin/mafft --genafpair --maxiterate 1000 --thread 1 '
                          f'../make_fastas2-2/out/{file_id}.tfa '
                          f'1> out/{file_id}.mfa 2> out/{file_id}.err'),
                ('clustalo', f'../../../bin/clustalo -i ../make_fastas2-2/out/{file_id}.tfa '
