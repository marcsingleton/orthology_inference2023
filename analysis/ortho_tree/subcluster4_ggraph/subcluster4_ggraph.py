...
CCs = []
with open('../connect_ggraph/out/gconnect.txt') as file:
    for line in file:
...
# Write OGs to file
j = 0
with open('out/gclusters.txt', 'w') as file:
...
plt.legend()
plt.savefig('out/connectnum-OGnum_type_dist1-1.png')
plt.xlim((-1, 17))  # Adjust axis to truncate outliers
plt.savefig('out/connectnum-OGnum_type_dist1-2.png')
plt.close()
...
plt.title('Distribution of connected components across number of OGs')
plt.legend()
plt.savefig('out/connectnum-OGnum_type_dist2-1.png')
plt.xlim((-1, 17))  # Adjust axis to truncate outliers
plt.savefig('out/connectnum-OGnum_type_dist2-2.png')
plt.close()
...
../connect_ggraph/connect_ggraph.py
    ../connect_ggraph/out/gconnect.txt
